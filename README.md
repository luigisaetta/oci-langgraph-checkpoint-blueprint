...
| [Example 04: Durable IT Procurement Agent and UI](examples/example04_nextjs_ui/README.md) | An independent pooled FastAPI and Next.js example that searches a deterministic IT catalogue, persists a simulated order proposal, and pauses for human approval. |
